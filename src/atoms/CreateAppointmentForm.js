  ...
  return (
      ...
      onSubmit={function (e) {
        ...
        if (onSubmit) {
          const payload = {
            ...
            meeting_length: formData.get("meeting_length") || 60,
    ...
    >
      ...
      <Form.Row className={"mb-3"}>
        <Form.Group as={Col} controlId="formEventType">
          ...
          >
            ...
            <option key="all-days" value="all-days">
              All Days
            </option>
            <option key="week-days" value="week-days">
              Week Days
            </option>
          </Form.Control>
          <Form.Text>Please select the type for this appointment.</Form.Text>
        </Form.Group>
      </Form.Row>
      ...
      <Form.Row className={"mb-1"}>
        <Form.Group as={Col} controlId="formEventStart">
          <Form.Control
            ...
            type="datetime-local"
            name="start_time"
            defaultValue={moment(selectedSlot?.start).format(
              "YYYY-MM-DDTHH:mm",
            )}
          />
        </Form.Group>
      ...
      <ActionRow>
        ...
        <Button type={"submit"} disabled={isSuperUser && !listMentors.length}>
          {slotInfo ? "Update" : "Create"}
        </Button>
      </ActionRow>
    </Form>
  );
