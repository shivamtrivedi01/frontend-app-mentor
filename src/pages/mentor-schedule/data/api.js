...
export async function updateEventReviewApi(eventId, payload) {
  const url = `${getConfig().LMS_BASE_URL}/mentoring/api/v1/mentoring-events/${eventId}/`;

  return getAuthenticatedHttpClient().patch(url, payload);
}
