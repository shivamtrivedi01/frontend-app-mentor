...
import BookedEvents from "./mentor-schedule/BookedEvents";
...
const LandingPage = (props) => {
  ...
  const { fetchMyRoles, fetchMentorList } = props;
  // Add state variables
      ...
      {/*{myRolesInfo?.is_superuser && (
        <Tabs variant="tabs">
          <Tab
            ...
            title="Schedule"
            className="mentor-schedule"
          >
            <MentorSchedule myRolesInfo={myRolesInfo} />
          </Tab>
          <Tab
            eventKey="mentor-magement"
            title="Manage Mentors"
            className="mentor-management"
          >
